...
def fastplot(
    ...
    if data_range != None:
        # data.plotOn(frame, ROOT.RooFit.Name("Data"), ROOT.RooFit.DataError(ROOT.RooAbsData.SumW2), ROOT.RooFit.CutRange(data_range))
        data.plotOn(
            frame,
    ...
    if pi_label:
        ...
        obs_range = round_to_1(
            observable.getMax() - observable.getMin()
        )  # stupid overflow artefacts
